...
3.	Statistical phase.
4.  Theoretical phase.
5.	Thesis writing and defence.

```{python}
#| warning: false
import pandas as pd
from pathlib import Path
from sarjana.scripts import gantt

progress = pd.read_csv(Path('..', 'data', 'meta', 'progress-got.csv'), parse_dates=['start', 'end'])
milestones = pd.read_csv(Path('..', 'data', 'meta', 'milestones.csv'), parse_dates=['date'])
