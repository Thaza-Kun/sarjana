---
title: "Possible Periodictity of Two Fast Radio Bursts (FRB) Repeaters with Limited Detections: FRB20190915D and  FRB20191106C"
authors: 
...
format:
  aft-pdf:
    classoption: [rmp, twocolumn]
    include-in-header: _twocolumn_longtable.tex
  pdf:
...
abstract: |
  ...
  This paper tries to characterize the periodicity of FRBs whose repetition seems to be limited within a certain timeframe -- FRB20190915D and FRB20191106C as the chosen examples -- from a 3 year dataset provided by the CHIME/FRB 2023 Catalog. 
  This paper found that the periodicity can be characterized with more than 50% certainty despite the limited samples given that the waiting time is bimodally distributed.
---

<!-- TODO Keywords -->
<!-- TODO Publication location -->
...
# Introduction
Fast Radio Burst (FRB) is a class of transients first discovered by @lorimer_BrightMillisecondRadio_2007 with currently unknown origin.
...
Its high dispersion measure suggests an extragalactic origin consistent with observation of identified hosts such as in @bannister_SingleFastRadio_2019, @chatterjee_DirectLocalizationFast_2017, and @ravi_FastRadioBurst_2019.
...
The population seem to favor non-repeating FRBs over repeating FRBs as @thechimefrbcollaborationCHIMEFastRadio2018 reports on 18 (3.7%) repeating sources are among 492 FRB sources detected [^catalog].
A recent paper [@andersen_CHIMEFRBDiscovery_2023] estimates that repeating sources constitutes about 2.6% of known FRBs.
...
This consistency does not prevent some authors in assuming that a small part of the non-repeating FRBs might repeat in the future dubbed as 'potentially repeating' or 'repeater candidates', as was done by @bohanchen_UncloakingHiddenRepeating_2021, @luo_MachineLearningClassification_2022, @zhu-ge_MachineLearningClassification_2022, and @pleunis_FastRadioBurst_2021.
...
[^catalog]: <https://www.chime-frb.ca/catalog>

# Methodology

This paper will examine the periodicity of FRB20190915D (10 detections) and FRB20191106C (7 detections) from the CHIME/FRB Catalog 2023^[<https://www.chime-frb.ca/repeater_catalog>] [@andersen_CHIMEFRBDiscovery_2023].
This paper will also include FRB20180916B (77 detections) from CHIME/FRB Catalog 1 [^catalog] [@thechimefrbcollaborationFirstCHIMEFRB2021] to compare the validity of methods since its periodicity value is well quantified to be around 16 days [@thechimefrbcollaborationPeriodicActivityFast2020; @sand_CHIMEFRBStudy_2023].
...
The results shown in @tbl-result accompanied by @fig-periodogram for FRB20180916B using Lomb--Scargle and Duty Cycle methods are consistent with the periodicities from @thechimefrbcollaborationPeriodicActivityFast2020 of 16.35±0.15 days and @sand_CHIMEFRBStudy_2023 of 16.34±0.07 days.
...
This pattern also emerges in the results for FRB20190915D with Lomb--Scargle and Duty Cycle methods showing a periodicity of 30.06±10.21 days and 29.97±0.95 days respectively, with Phase Dispersion Minimization offshooting to 1.5~1.6 times the two values.
...
We would like to acknowledge the grant <TODO: GRANT NUMBER> for funding the research activities of the radio cosmology lab group in Universiti Malaya in which the development of the Malaysian VGOS radio telescope is taking place.
